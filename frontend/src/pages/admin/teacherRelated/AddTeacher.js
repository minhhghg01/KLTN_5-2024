    ...
    <div>
      <div className="register">
        <form className="registerForm" onSubmit={submitHandler}>
          ...
          <label>
            Lớp học : {subjectDetails && subjectDetails.sclassName && subjectDetails.sclassName.sclassName}
          </label>
          <label>Họ và tên </label>
          <input className="registerInput" type="text" placeholder="Nhập tên của giáo viên"
            value={name}
